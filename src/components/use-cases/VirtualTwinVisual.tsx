...
const VirtualTwinVisual: React.FC = () => {
  return (
    <div className="bg-slate-50 p-4 sm:p-8 rounded-xl shadow-lg flex flex-col items-center">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 w-full">
            {/* Wearable Data Source */}
            <div className="flex flex-col items-center text-center">
                <Watch className="w-16 h-16 text-blue-500 mb-2" />
                <h4 className="font-semibold">Wearable Devices</h4>
                <p className="text-sm text-gray-600 max-w-xs">Real-time data stream (Heart Rate, Activity, Sleep)</p>
            </div>

            <ArrowRight className="w-8 h-8 text-gray-400 my-4 md:my-0 -rotate-90 md:rotate-0" />
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600 max-w-xs">Dynamic model adapts to physiological changes</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600 max-w-xs">Personalized and adaptive drug therapy</p>
            </div>
        </div>
    </div>
  );
